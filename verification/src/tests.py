TESTS = {
    "Rank_01": [
        ...
        },
        {
            ...
            "answer": 5},
        {
            "input": "To take a trivial example, which of us ever undertakes "
                     "laborious physical exercise, except to obtain some advantage from it?",
            "answer": 8},
        {
            "input": "The European languages are members of the same family. "
                     "Their separate existence is a myth.",
            "answer": 6},
        {
            "input": "For science, music, sport, etc, Europe uses the same vocabulary. "
        ...
        },
        {
            "input": "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. "
                     ...
                     "leo eget bibendum sodales, augue velit cursus nunc, quis gravida "
                     "magna mi a libero. Fusce vulputate eleifend sapien. Vestibulum purus "
                     "quam, scelerisque ut, mollis sed, nonummy id, metus. Nullam accumsan "
                     "lorem in dui. Cras ultricies mi eu turpis hendrerit fringilla. "
                     "Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere "
                     "cubilia Curae; In ac dui quis mi consectetuer lacinia. Nam pretium turpis "
                     ...
                     "hendrerit quis, nisi. Curabitur ligula sapien, tincidunt non, euismod "
                     "vitae, posuere imperdiet, leo. Maecenas malesuada. Praesent congue erat "
                     "at massa. Sed cursus turpis vitae tortor. Donec posuere vulputate arcu. "
                     ...
                     "dolor sagittis lacus. Donec elit libero, sodales nec, volutpat a, suscipit "
                     "non, turpis. Nullam sagittis. Suspendisse pulvinar, augue ac venenatis "
                     "condimentum, sem libero volutpat nibh, nec pellentesque velit pede quis "
                     ...
                     "Ut non enim eleifend felis pretium feugiat. Vivamus quis mi. Phasellus "
                     "a est. Phasellus magna. In hac habitasse platea dictumst. Curabitur at "
                     ...
                     "quis pede. Donec interdum, metus et hendrerit aliquet, dolor diam sagittis "
                     ...
                     "condimentum nec, tempor a, commodo mollis, magna. Vestibulum ullamcorper "
                     "mauris at ligula. Fusce fermentum. Nullam cursus lacinia erat. Praesent "
                     "blandit laoreet nibh. Fusce convallis metus id felis luctus adipiscing. "
                     ...
                     "Ut tincidunt tincidunt erat. Etiam feugiat lorem non metus. Vestibulum "
                     "dapibus nunc ac augue. Curabitur vestibulum aliquam leo. Praesent egestas "
                     "neque eu enim. In hac habitasse platea dictumst. Fusce a quam. "
                     ...
                     "adipiscing, dui. Vestibulum facilisis, purus nec pulvinar iaculis, ligula "
                     "mi congue nunc, vitae euismod ligula urna in dolor. Mauris sollicitudin "
                     ...
                     "gravida nisl, id fringilla neque ante vel mi. Morbi mollis tellus "
                     "ac sapien. Phasellus volutpat, metus eget egestas mollis, lacus lacus "
                     ...
                     "elementum eu, semper a, adipiscing nec, purus. Cras risus ipsum, "
                     "faucibus ut, ullamcorper id, varius ac, leo. Suspendisse feugiat. "
                     "Suspendisse enim turpis, dictum sed, iaculis a, condimentum nec, "
                     "nisi. Praesent nec nisl a purus blandit viverra. Praesent ac massa "
                     "at ligula laoreet iaculis. Nulla neque dolor, sagittis eget, iaculis "
                     "quis, molestie non, velit. Mauris turpis nunc, blandit et, volutpat "
                     "molestie, porta ut, ligula. Fusce pharetra convallis urna. "
                     "Quisque ut nisi. Donec mi odio, faucibus at, scelerisque quis, "
                     "convallis in, nisi. Suspendisse non nisl sit amet velit hendrerit "
                     "rutrum. Ut leo. Ut a nisl id ante tempus hendrerit. Proin pretium, "
                     "leo ac pellentesque mollis, felis nunc ultrices eros, sed gravida augue "
                     "augue mollis justo. Suspendisse eu ligula. Nulla facilisi. "
                     "Donec id justo. Praesent porttitor, nulla vitae posuere iaculis, "
                     "arcu nisl dignissim dolor, "
                     "a pretium mi sem ut ipsum. Curabitur suscipit suscipit tellus. "
                     "Praesent vestibulum dapibus nibh. Etiam iaculis nunc ac metus. "
                     "Ut id nisl quis enim dignissim sagittis. Etiam sollicitudin, "
                     "ipsum eu pulvinar rutrum, tellus ipsum laoreet sapien, quis "
                     "venenatis ante odio sit amet eros. Proin magna. Duis vel nibh at "
                     "velit scelerisque suscipit. Curabitur turpis. Vestibulum suscipit "
                     "nulla quis orci. Fusce ac felis sit amet ligula pharetra condimentum. "
                     "Maecenas egestas arcu quis ligula mattis placerat. Duis lobortis massa "
                     "imperdiet quam. Suspendisse potenti. Pellentesque commodo eros a enim. "
                     "Vestibulum turpis sem, aliquet eget, lobortis pellentesque, "
                     "rutrum eu, nisl. Sed libero. Aliquam erat volutpat. Etiam vitae tortor. "
                     "Morbi vestibulum volutpat enim. Aliquam eu nunc. Nunc sed turpis. "
                     "Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, "
                     "non adipiscing dolor urna a orci. Nulla porta dolor. Class aptent taciti "
                     ...
                     "sagittis. Aliquam lobortis. Donec orci lectus, aliquam ut, faucibus non, "
                     "euismod id, nulla. Curabitur blandit mollis lacus. Nam adipiscing. "
                     "Vestibulum eu odio. Vivamus laoreet. Nullam tincidunt adipiscing enim. "
                     ...
                     "Praesent ut ligula non mi varius sagittis. Cras sagittis. Praesent "
                     "ac sem eget est egestas volutpat. Vivamus consectetuer "
                     "hendrerit lacus. Cras non dolor. Vivamus in erat ut urna cursus vestibulum. "
                     "Fusce commodo aliquam arcu. Nam commodo suscipit quam. Quisque id odio. "
                     "Praesent venenatis metus at tortor pulvinar varius. Lorem ipsum dolor sit "
